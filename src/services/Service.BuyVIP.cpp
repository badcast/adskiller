...
bool BuyVIPService::start()
{
    ...
    QObject::connect(network, &Network::sPullServiceGUID, this, &BuyVIPService::service_uuid_responce);
    ...
    network->pullServiceGUID(guid(), QJsonObject {}, ServiceOperation::Get);
    return true;
}
...
void BuyVIPService::click_buy_vip()
{
    ...
    network->pullServiceGUID(guid(), request, ServiceOperation::Set);
}
