...
public:
    ...
    explicit AdbDeviceVisualizer(QWidget *parent = nullptr) : QWidget(parent), m_status(UNKNOWN), m_time(0.0f), m_connectedTime(0.0f)
    {
...
protected:
    void paintEvent(QPaintEvent *event) override
    {
        ...
        else
        {
            ...
            p.drawText(QRectF(screenRect.left() + 6.0f, iconCenterY + 42.0f, screenRect.width() - 12.0f, 20.0f), Qt::AlignCenter, QString::fromUtf8("ПОИСК УСТРОЙСТВА"));
            ...
            p.setFont(sDesc);
            p.setPen(QColor(148, 163, 184));
            p.drawText(QRectF(screenRect.left() + 6.0f, iconCenterY + 62.0f, screenRect.width() - 12.0f, 18.0f), Qt::AlignCenter, QString::fromUtf8("Подключите USB-кабель"));
